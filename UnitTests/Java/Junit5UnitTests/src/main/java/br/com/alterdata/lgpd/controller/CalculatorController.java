package br.com.alterdata.lgpd.controller;
...
public class CalculatorController {
    ...
    @GetMapping("/sum")
    public ResponseEntity<Integer> sum(@RequestParam int a,
                                       @RequestParam int b){
        return ResponseEntity.ok(this.calculator.sum(a,b));
    }

    @GetMapping("/subtract")
    public ResponseEntity<Integer> subtract(@RequestParam int a,
                                            @RequestParam int b){
    ...
    @GetMapping("/multiply")
    public ResponseEntity<Integer> multiply(@RequestParam int a,
                                            @RequestParam int b){
    ...
    @GetMapping("/divide")
    public ResponseEntity<Integer> divide(@RequestParam int a,
                                          @RequestParam int b){
    ...
    public ResponseEntity<Integer> sumAndMultiply(@RequestParam int a,
                                                  @RequestParam int b,
                                                  @RequestParam int c){
